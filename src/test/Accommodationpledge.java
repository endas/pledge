...
/**
 * Accommodationpledge generated by hbm2java
 */
@Entity
@Table(name = "ACCOMMODATIONPLEDGE", catalog = "netgrains")
public class Accommodationpledge implements java.io.Serializable {
	...
	public Accommodationpledge() {
	}

	public Accommodationpledge(String addressone, String addresstwo, long country) {
		this.addressone = addressone;
		this.addresstwo = addresstwo;
		this.country = country;
	}

	public Accommodationpledge(String addressone, String addresstwo, String city, String stateprovinceregion,
			String postcode, long country, Long owneroccupier, Date accommodationdatefrom, Date accommodationdateto,
			Long accommodationtype, Long accommodationcondition, Long numberofbeds, Long vacantorshared,
			String otheramenities, Boolean accommodatefamily, Boolean accommodatecouple, Boolean accommodatesinglemale,
			Boolean accommodatesinglefemale, String additionalinformation, Long registerofpledgesid, Long createdbyid,
	...
	@Column(name = "ACCOMMODATIONPLEDGEID", unique = true, nullable = false)
