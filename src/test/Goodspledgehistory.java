...
/**
 * Goodspledgehistory generated by hbm2java
 */
@Entity
@Table(name = "GOODSPLEDGEHISTORY", catalog = "netgrains")
public class Goodspledgehistory implements java.io.Serializable {

	private Long goodspledgehistoryid;
	...
	public Goodspledgehistory(Long goodspledgeid, Long goodscategoryone, Long goodscategorytwo, Long goodscategorythree,
			Long goodssize, Long goodsneworused, Long goodscondition, Long goodsquantity, String additionalinformation,
			String itemsize, Date dateavailablefrom, Date dateavailableto, Long createdbyid, Long updatedbyid,
	...
	@Column(name = "GOODSPLEDGEHISTORYID", unique = true, nullable = false)
	public Long getGoodspledgehistoryid() {
		return this.goodspledgehistoryid;
	}

	public void setGoodspledgehistoryid(Long goodspledgehistoryid) {
		this.goodspledgehistoryid = goodspledgehistoryid;
	}

	@Column(name = "GOODSPLEDGEID")
