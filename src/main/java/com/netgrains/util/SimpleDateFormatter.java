...
public class SimpleDateFormatter
{
	 ...
	 */
	static private SimpleDateFormatter instance = null;
	
    /** The SimpleDateFormat used to format dates and Strings to/from dd/MM/yyyy	**/
    SimpleDateFormat simpleDateFormat; 	
	
	/**
	 * Default Constructor for the SimpleDateFormatter class
	 */
	 ...
	 */
	static public SimpleDateFormatter getInstance()
	{
		if(instance == null)
		{
		   instance = new SimpleDateFormatter();
		}
		return instance;
	}
