...
public class ReferenceCategoryTranslationBackingBeanImpl extends ReferenceCategoryImpl implements ReferenceCategoryTranslationBackingBean, Serializable { 
    ...
    public ReferenceCategoryTranslationBackingBeanImpl()
    {
		...
		referenceCategoryDescLabelMessageKey = new String();  
		referenceCategoryDescLabel = new String();
		referenceCategoryDescPlaceHolderMessageKey = new String();
		referenceCategoryDescPlaceHolder = new String();
		referenceCategoryDescHelpTextMessageKey = new String();
		referenceCategoryDescHelpText = new String();
		referenceCategoryDescTooltipMessageKey = new String();
		referenceCategoryDescTooltip = new String();
		parentCategoryIdLabelMessageKey = new String();  
		parentCategoryIdLabel = new String();
		parentCategoryIdPlaceHolderMessageKey = new String();
		parentCategoryIdPlaceHolder = new String();
		parentCategoryIdHelpTextMessageKey = new String();
		parentCategoryIdHelpText = new String();
		parentCategoryIdTooltipMessageKey = new String();
		parentCategoryIdTooltip = new String();
