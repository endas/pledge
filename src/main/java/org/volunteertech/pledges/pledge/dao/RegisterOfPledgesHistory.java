 ...
 *
 */
public class RegisterOfPledgesHistory
{
	/** Hibernate Id */
	private Long id;
    ...
    /*
     * Returns the RegisterOfPledgesID for the parent record
     */
	public Long getRegisterOfPledgesID()
	{
        return registerOfPledgesID;
    }
	 ...
	 */
	@SuppressWarnings("unused")
    private void setRegisterOfPledgesID(Long registerOfPledgesID)
    {
