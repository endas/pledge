...
public class MessageResourceTranslationBackingBeanImpl extends MessageResourceImpl implements MessageResourceTranslationBackingBean, Serializable { 
    ...
    public MessageResourceTranslationBackingBeanImpl()
    {
		...
		messageKeyLabelMessageKey = new String();  
		messageKeyLabel = new String();
		messageKeyPlaceHolderMessageKey = new String();
		messageKeyPlaceHolder = new String();
		messageKeyHelpTextMessageKey = new String();
		messageKeyHelpText = new String();
		messageKeyTooltipMessageKey = new String();
		messageKeyTooltip = new String();
		localeLabelMessageKey = new String();  
		localeLabel = new String();
		localePlaceHolderMessageKey = new String();
		localePlaceHolder = new String();
		localeHelpTextMessageKey = new String();
		localeHelpText = new String();
		localeTooltipMessageKey = new String();
		localeTooltip = new String();
		localeReferenceIdLabelMessageKey = new String();  
		localeReferenceIdLabel = new String();
		localeReferenceIdPlaceHolderMessageKey = new String();
		localeReferenceIdPlaceHolder = new String();
		localeReferenceIdHelpTextMessageKey = new String();
		localeReferenceIdHelpText = new String();
		localeReferenceIdTooltipMessageKey = new String();
		localeReferenceIdTooltip = new String();
		messageLabelMessageKey = new String();  
		messageLabel = new String();
		messagePlaceHolderMessageKey = new String();
		messagePlaceHolder = new String();
		messageHelpTextMessageKey = new String();
		messageHelpText = new String();
		messageTooltipMessageKey = new String();
		messageTooltip = new String();
