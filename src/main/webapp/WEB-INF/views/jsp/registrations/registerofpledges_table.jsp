...
<spring:url value="/resources/images/redcross-brand-logo.png" var="headerLogo" />
	...
	<div class="container">
		...
		<table id="registerOfPledgesTable" class="table table-striped table-bordered">
			<thead>
				<tr>
...
<spring:url value="/wro/registerOfPledgesTableJs.js" var="registerOfPledgesTableJs" />
  
<script src="${registerOfPledgesTableJs}"></script>
