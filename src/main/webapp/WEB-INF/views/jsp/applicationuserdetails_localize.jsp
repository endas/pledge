        ...
        <%@ taglib  uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
                ...
                <body>
                    ...
                    <form:form id="frmApplicationUserDetails" role="form" class="form-horizontal" method="post" accept-charset="utf-8" modelAttribute="applicationUserDetailsTranslationFormModel" action="${applicationUserDetailsActionUrl}">
                        ...
                        <div class="container">
                            ...
                            <div class="form-group">
                                ...
                                <label id="pageTitleTranslateToLabel" for="applicationuserdetails.form.title.localizer.input" class="col-sm-1 control-label left-align">
                                    <spring:message code="newLocaleLabel" />
                                </label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <label id="pageHeaderTitleTranslateToLabel" for="applicationuserdetails.form.header.localizer.input" class="col-sm-1 control-label left-align">
                                    <spring:message code="newLocaleLabel" />
                                </label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <label id="pageSubHeaderTitleTranslateToLabel" for="applicationuserdetails.form.subheader.localizer.input" class="col-sm-1 control-label left-align">
                                    <spring:message code="newLocaleLabel" />
                                </label>
                                <div class="col-sm-6">
                        ...
                        <!-- id="applicationUserDetailsFormHeaderSection -->
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsContactInformationInstructionsMessageTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsContactInformationInstructionsMessageLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsContactInformationInstructionsMessageTranslateToLabel" for="frmApplicationUserDetailsContactInformationInstructionsMessageLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsContactNameLabelTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsContactNameLabelLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsContactNameLabelTranslateToLabel" for="frmApplicationUserDetailsContactNameLabelLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsContactNamePlaceHolderTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsContactNamePlaceHolderLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsContactNamePlaceHolderTranslateToLabel" for="frmApplicationUserDetailsContactNamePlaceHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsContactNameHelpBlockTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsContactNameHelpBlockLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsContactNameHelpBlockTranslateToLabel" for="frmApplicationUserDetailsContactNameHelpBlockHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsRepresentOrganisationLabelTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsRepresentOrganisationLabelLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsRepresentOrganisationLabelTranslateToLabel" for="frmApplicationUserDetailsRepresentOrganisationLabelLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsRepresentOrganisationPlaceHolderTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsRepresentOrganisationPlaceHolderLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsRepresentOrganisationPlaceHolderTranslateToLabel" for="frmApplicationUserDetailsRepresentOrganisationPlaceHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsRepresentOrganisationHelpBlockTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsRepresentOrganisationHelpBlockLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsRepresentOrganisationHelpBlockTranslateToLabel" for="frmApplicationUserDetailsRepresentOrganisationHelpBlockHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsTelephoneNumberLabelTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsTelephoneNumberLabelLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsTelephoneNumberLabelTranslateToLabel" for="frmApplicationUserDetailsTelephoneNumberLabelLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsTelephoneNumberPlaceHolderTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsTelephoneNumberPlaceHolderLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsTelephoneNumberPlaceHolderTranslateToLabel" for="frmApplicationUserDetailsTelephoneNumberPlaceHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsTelephoneNumberHelpBlockTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsTelephoneNumberHelpBlockLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsTelephoneNumberHelpBlockTranslateToLabel" for="frmApplicationUserDetailsTelephoneNumberHelpBlockHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsAddressOneLabelTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsAddressOneLabelLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsAddressOneLabelTranslateToLabel" for="frmApplicationUserDetailsAddressOneLabelLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsAddressOnePlaceHolderTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsAddressOnePlaceHolderLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsAddressOnePlaceHolderTranslateToLabel" for="frmApplicationUserDetailsAddressOnePlaceHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsAddressOneHelpBlockTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsAddressOneHelpBlockLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsAddressOneHelpBlockTranslateToLabel" for="frmApplicationUserDetailsAddressOneHelpBlockHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsAddressTwoLabelTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsAddressTwoLabelLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsAddressTwoLabelTranslateToLabel" for="frmApplicationUserDetailsAddressTwoLabelLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsAddressTwoPlaceHolderTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsAddressTwoPlaceHolderLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsAddressTwoPlaceHolderTranslateToLabel" for="frmApplicationUserDetailsAddressTwoPlaceHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsAddressTwoHelpBlockTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsAddressTwoHelpBlockLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsAddressTwoHelpBlockTranslateToLabel" for="frmApplicationUserDetailsAddressTwoHelpBlockHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsCityLabelTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsCityLabelLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsCityLabelTranslateToLabel" for="frmApplicationUserDetailsCityLabelLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsCityPlaceHolderTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsCityPlaceHolderLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsCityPlaceHolderTranslateToLabel" for="frmApplicationUserDetailsCityPlaceHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsCityHelpBlockTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsCityHelpBlockLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsCityHelpBlockTranslateToLabel" for="frmApplicationUserDetailsCityHelpBlockHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsStateProvinceRegionLabelTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsStateProvinceRegionLabelLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsStateProvinceRegionLabelTranslateToLabel" for="frmApplicationUserDetailsStateProvinceRegionLabelLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsStateProvinceRegionPlaceHolderTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsStateProvinceRegionPlaceHolderLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsStateProvinceRegionPlaceHolderTranslateToLabel" for="frmApplicationUserDetailsStateProvinceRegionPlaceHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsStateProvinceRegionHelpBlockTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsStateProvinceRegionHelpBlockLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsStateProvinceRegionHelpBlockTranslateToLabel" for="frmApplicationUserDetailsStateProvinceRegionHelpBlockHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsPostCodeLabelTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsPostCodeLabelLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsPostCodeLabelTranslateToLabel" for="frmApplicationUserDetailsPostCodeLabelLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsPostCodePlaceHolderTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsPostCodePlaceHolderLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsPostCodePlaceHolderTranslateToLabel" for="frmApplicationUserDetailsPostCodePlaceHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsPostCodeHelpBlockTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsPostCodeHelpBlockLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsPostCodeHelpBlockTranslateToLabel" for="frmApplicationUserDetailsPostCodeHelpBlockHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsCountryLabelTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsCountryLabelLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsCountryLabelTranslateToLabel" for="frmApplicationUserDetailsCountryLabelLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsCountryPlaceHolderTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsCountryPlaceHolderLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsCountryPlaceHolderTranslateToLabel" for="frmApplicationUserDetailsCountryPlaceHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsCountryHelpBlockTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsCountryHelpBlockLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsCountryHelpBlockTranslateToLabel" for="frmApplicationUserDetailsCountryHelpBlockHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsEmailAddressLabelTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsEmailAddressLabelLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsEmailAddressLabelTranslateToLabel" for="frmApplicationUserDetailsEmailAddressLabelLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsEmailAddressPlaceHolderTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsEmailAddressPlaceHolderLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsEmailAddressPlaceHolderTranslateToLabel" for="frmApplicationUserDetailsEmailAddressPlaceHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label id="frmApplicationUserDetailsEmailAddressHelpBlockTranslateFromLabel" class="col-sm-1 control-label left-align">
                                                <spring:message code="existingLocaleLabel" />
                                            </label>
                                            <p id="frmApplicationUserDetailsEmailAddressHelpBlockLocalizerLabel" class="col-sm-4 form-control-static"></p>
                                            <label id="frmApplicationUserDetailsEmailAddressHelpBlockTranslateToLabel" for="frmApplicationUserDetailsEmailAddressHelpBlockHolderLocalizer" class="col-sm-1 control-label left-align">
                                                <spring:message code="newLocaleLabel" />
                                            </label>
                                            <div class="col-sm-6">
