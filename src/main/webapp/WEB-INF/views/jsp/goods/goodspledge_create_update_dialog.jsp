...
<div class="modal fade" id="goodsPledgeCreateUpdateModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
      ...
      <div class="modal-body">
        ...
        <form id="frmGoodsPledgeCreateUpdate" role="form" action="restful/goodspledge" method="post">
		  ...
		  <div id="frmGoodsPledgeCreateUpdateGoodsCategoryTwoFormGroup" class="form-group has-feedback  ${status.error ? 'has-error' : ''} collapse">
			...
			<select class="form-control" data-display-name="Goods Category Two" data-select-type="standalone" data-required="false" id="frmGoodsPledgeCreateUpdateGoodsCategoryTwo" aria-describedby="frmGoodsPledgeCreateUpdateGoodsCategoryTwoHelpBlock" 
			onchange="loadChildSelectAndSelectValue(this, document.getElementById('frmGoodsPledgeCreateUpdateGoodsCategoryThree'), 'theValueToSet', 'GoodsCategoryThree', '<spring:message code="frmGoodsPledgePledgedGoodsPlaceHolder"/>');loadChildSelectAndSelectValue(this, document.getElementById('frmGoodsPledgeCreateUpdateGoodsSize'), 'theValueToSet', 'GoodsSize', '<spring:message code="frmGoodsPledgePledgedGoodsPlaceHolder"/>')">
			</select>
    ...
    <span id="frmGoodsPledgeCreateUpdateAdditionalInformationCountBlock" class="help-block"></span>
		...
		<div class="form-group">
            <input type="checkbox" data-display-name="Same Address as Profile"
              ...
              /> <label id="pledge.sameAsProfileAddress.label" for="pledgeSameAsProfileAddress" class="control-label"><spring:message code="frmGoodsSameAsProfileAddress"/></label> 
        </div>
