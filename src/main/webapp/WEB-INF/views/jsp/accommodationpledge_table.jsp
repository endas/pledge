...
<spring:url value="/resources/images/redcross-brand-logo.png" var="headerLogo" />
	...
	<div class="container">
		...
		<table id="accommodationPledgeTable" class="table table-striped table-bordered">
			<thead>
				<tr>
					<th></th> <!-- Actions buttons -->
					 
					<th><spring:message code="frmAccommodationPledgeAddressOneLabel"/></th>      
       
					<th><spring:message code="frmAccommodationPledgeAddressTwoLabel"/></th>      
       
					<th><spring:message code="frmAccommodationPledgeCityLabel"/></th>      
       
					<th><spring:message code="frmAccommodationPledgeStateProvinceRegionLabel"/></th>      
       
					<th><spring:message code="frmAccommodationPledgePostCodeLabel"/></th>      
       
					<th><spring:message code="frmAccommodationPledgeCountryLabel"/></th>      
...
<spring:url value="/wro/accommodationPledgeTableJs.js" var="accommodationPledgeTableJs" />
  
<script src="${accommodationPledgeTableJs}"></script>
