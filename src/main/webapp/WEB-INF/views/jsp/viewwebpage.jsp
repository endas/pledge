...
<spring:url value="applicationuser/createuser" var="urlCreateUser" />
    ...
    <nav class="navbar navbar-fixed-top navbar-default">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
				...
				<li><a role="button" data-toggle="modal" data-backdrop="static" data-target="#messageResourceCreateUpdateModal" data-id=null data-modal-title="Add Message" data-association-type="one-to-many" data-callback-display-type="table" data-callback-table-body-id="messageResourceTableBody" data-property-url="messageresource">Add Message</a></li>
     ...
     <div class="container-fluid hero">
			...
			<div class="jumbotron">
			  <h1><spring:message code="view.form.header"/></h1>
			  
			  <p><spring:message code="view.form.subheader"/></p>
