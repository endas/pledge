...
<spring:url value="/resources/images/redcross-brand-logo.png" var="headerLogo" />
	...
	<div class="container">
		<div class="page-header">
			<h1><spring:message code="landing.form.header"/></h1>
		</div>
	</div>
	...
	<div class="container">
		...
		<table id="landingTable" class="table table-striped table-bordered">
			<thead>
				<tr>
...
<spring:url value="/wro/landingTableJs.js" var="landingTableJs" />
  
<script src="${landingTableJs}"></script>
