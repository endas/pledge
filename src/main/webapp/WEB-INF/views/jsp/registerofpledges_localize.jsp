...
<spring:url value="/resources/images/redcross-brand-logo.png" var="headerLogo" />
	...
	<form:form id="frmRegisterOfPledges" role="form" class="form-horizontal" method="post" accept-charset="utf-8"
                modelAttribute="registerOfPledgesTranslationFormModel" action="${registerOfPledgesActionUrl}">
	...
	<div class="container">
		  ...
		  <div class="form-group">
			...
			<label id="pageTitleTranslateToLabel" for="registerofpledges.form.title.localizer.input" class="col-sm-1 control-label left-align"><spring:message code="newLocaleLabel"/></label>
			<div class="col-sm-6">
		  ...
		  <div class="form-group">
			...
			<label id="pageHeaderTitleTranslateToLabel" for="registerofpledges.form.header.localizer.input" class="col-sm-1 control-label left-align"><spring:message code="newLocaleLabel"/></label>
			<div class="col-sm-6">
		  ...
		  <div class="form-group">
			...
			<label id="pageSubHeaderTitleTranslateToLabel" for="registerofpledges.form.subheader.localizer.input" class="col-sm-1 control-label left-align"><spring:message code="newLocaleLabel"/></label>
			<div class="col-sm-6">
	...
	</section> <!-- id="registerOfPledgesFormHeaderSection --> 
	...
	<div class="container">
		...
		<div class="well">
		  ...
		  <div class="form-group">
		  	<label id="frmRegisterOfPledgesContactInformationInstructionsMessageTranslateFromLabel" class="col-sm-1 control-label left-align"><spring:message code="existingLocaleLabel"/></label>
			<p id="frmRegisterOfPledgesContactInformationInstructionsMessageLocalizerLabel" class="col-sm-4 form-control-static"></p>
			<label id="frmRegisterOfPledgesContactInformationInstructionsMessageTranslateToLabel" for="frmRegisterOfPledgesContactInformationInstructionsMessageLocalizer" class="col-sm-1 control-label left-align"><spring:message code="newLocaleLabel"/></label>
			<div class="col-sm-6">
	...
	<div class="container">
		...
		<div class="well">
		  ...
		  <div class="form-group">
		  	<label id="frmRegisterOfPledgesAccommodationPledgeInstructionsMessageTranslateFromLabel" class="col-sm-1 control-label left-align"><spring:message code="existingLocaleLabel"/></label>
			<p id="frmRegisterOfPledgesAccommodationPledgeInstructionsMessageLocalizerLabel" class="col-sm-4 form-control-static"></p>
			<label id="frmRegisterOfPledgesAccommodationPledgeInstructionsMessageTranslateToLabel" for="frmRegisterOfPledgesAccommodationPledgeInstructionsMessageLocalizer" class="col-sm-1 control-label left-align"><spring:message code="newLocaleLabel"/></label>
			<div class="col-sm-6">
	...
	<div class="container">
		...
		<div class="well">
		  ...
		  <div class="form-group">
		  	<label id="frmRegisterOfPledgesServicePledgeInstructionsMessageTranslateFromLabel" class="col-sm-1 control-label left-align"><spring:message code="existingLocaleLabel"/></label>
			<p id="frmRegisterOfPledgesServicePledgeInstructionsMessageLocalizerLabel" class="col-sm-4 form-control-static"></p>
			<label id="frmRegisterOfPledgesServicePledgeInstructionsMessageTranslateToLabel" for="frmRegisterOfPledgesServicePledgeInstructionsMessageLocalizer" class="col-sm-1 control-label left-align"><spring:message code="newLocaleLabel"/></label>
			<div class="col-sm-6">
	...
	<div class="container">
		...
		<div class="well">
		  ...
		  <div class="form-group">
		  	<label id="frmRegisterOfPledgesGoodsPledgeInstructionsMessageTranslateFromLabel" class="col-sm-1 control-label left-align"><spring:message code="existingLocaleLabel"/></label>
			<p id="frmRegisterOfPledgesGoodsPledgeInstructionsMessageLocalizerLabel" class="col-sm-4 form-control-static"></p>
			<label id="frmRegisterOfPledgesGoodsPledgeInstructionsMessageTranslateToLabel" for="frmRegisterOfPledgesGoodsPledgeInstructionsMessageLocalizer" class="col-sm-1 control-label left-align"><spring:message code="newLocaleLabel"/></label>
			<div class="col-sm-6">
