...
<div class="container">
	...
	<div class="row">
		<label class="col-sm-2">View Name</label>
		<div class="col-sm-10">${view.viewName}</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-sm-10">${view.saveButton}</div>
	</div>
...
<spring:url value="/scripts/js/view/view.js" var="viewJs" />
</body>
</html>
