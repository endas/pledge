...
<spring:url value="/resources/images/redcross-brand-logo.png" var="headerLogo" />
	...
	<div class="container">
		...
		<table id="applicationUserTable" class="table table-striped table-bordered">
			<thead>
				<tr>
					<th></th> <!-- Actions buttons -->
					 
					<th><spring:message code="frmApplicationUserUsernameLabel"/></th>      
       
					<th><spring:message code="frmApplicationUserPasswordLabel"/></th>      
       
					<th><spring:message code="frmApplicationUserEnabledLabel"/></th>      
...
<spring:url value="/wro/applicationUserTableJs.js" var="applicationUserTableJs" />
  
<script src="${applicationUserTableJs}"></script>
