...
<spring:url value="/resources/images/redcross-brand-logo.png" var="headerLogo" />
	...
	<div class="container">
		...
		<table id="applicationUserDetailsTable" class="table table-striped table-bordered">
			<thead>
				<tr>
					<th></th> <!-- Actions buttons -->
					 
					<th><spring:message code="frmApplicationUserDetailsContactNameLabel"/></th>      
       
					<th><spring:message code="frmApplicationUserDetailsRepresentOrganisationLabel"/></th>      
       
					<th><spring:message code="frmApplicationUserDetailsTelephoneNumberLabel"/></th>      
       
					<th><spring:message code="frmApplicationUserDetailsAddressOneLabel"/></th>      
       
					<th><spring:message code="frmApplicationUserDetailsAddressTwoLabel"/></th>      
       
					<th><spring:message code="frmApplicationUserDetailsCityLabel"/></th>      
       
					<th><spring:message code="frmApplicationUserDetailsStateProvinceRegionLabel"/></th>      
       
					<th><spring:message code="frmApplicationUserDetailsPostCodeLabel"/></th>      
       
					<th><spring:message code="frmApplicationUserDetailsCountryLabel"/></th>      
       
					<th><spring:message code="frmApplicationUserDetailsEmailAddressLabel"/></th>      
...
<spring:url value="/wro/applicationUserDetailsTableJs.js" var="applicationUserDetailsTableJs" />
  
<script src="${applicationUserDetailsTableJs}"></script>
