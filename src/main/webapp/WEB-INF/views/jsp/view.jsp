        ...
        <%@ taglib  uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
                ...
                <body>
                    ...
                    <form:form id="frmView" role="form" class="form-horizontal" method="post" accept-charset="utf-8" modelAttribute="viewFormModel" action="${viewActionUrl}">
                        ...
                        <!-- id="viewFormHeaderSection -->

                        <div class="container">
                            <div class="panel panel-default">

                                <div class="panel-heading">
                                    <h2><spring:message code="view.form.panel.viewinputspanel.headertext"/></h2></div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <spring:bind path="viewName">
                                        ...
                                        <div id="frmViewViewNameFormGroup" class="form-group has-feedback ${status.error ? 'has-error' : ''}">
                                            ...
                                            <label id="frmViewViewNameLabel" for="frmViewViewName" class="col-sm-2 control-label">
                                                <spring:message code="frmViewViewNameLabel" />
                                            </label>
                        ...
                        <div class="container">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h2><spring:message code="view.form.panel.viewmessagespanel.headertext"/></h2></div>
                                        ...
                                        <table id="messageResourceTable" class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <spring:message code="frmMessageResourceMessageKeyLabel" />
                                                    </th>

                                                    <th>
                                                        <spring:message code="frmMessageResourceLocaleLabel" />
                                                    </th>

                                                    <th>
                                                        <spring:message code="frmMessageResourceMessageLabel" />
                                                    </th>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body text-center">
                                    ...
                                    <button type="submit" class="btn-lg btn-primary">
                                        <spring:message code="frmViewSaveButtonLabel" />
                                    </button>
