...
<spring:url value="/resources/images/redcross-brand-logo.png" var="headerLogo" />
	...
	<div class="container">
		...
		<table id="messageResourceTable" class="table table-striped table-bordered">
			<thead>
				<tr>
					...
					<th><spring:message code="frmMessageResourceLocaleReferenceIdLabel"/></th>      
...
<spring:url value="/wro/messageResourceTableJs.js" var="messageResourceTableJs" />
  
<script src="${messageResourceTableJs}"></script>
