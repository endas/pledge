		...
		<spring:bind path="stateProvinceRegion">
		  <div id="frmAddressStateProvinceRegionFormGroup" class="form-group ${status.error ? 'has-error' : ''}">
			...
			<div class="col-sm-10">
				...
				<form:input path="stateProvinceRegion" type="text" maxlength="50" class="form-control" id="frmAddressStateProvinceRegion" placeholder="County"  />
		...
		<spring:bind path="postCode">
		  <div id="frmAddressPostCodeFormGroup" class="form-group ${status.error ? 'has-error' : ''}">
			...
			<div class="col-sm-10">
				...
				<form:input path="postCode" type="text" maxlength="10" class="form-control" id="frmAddressPostCode" placeholder="Eircode"  />
