...
<spring:url value="/resources/images/redcross-brand-logo.png" var="headerLogo" />
	...
	<div class="container">
		...
		<table id="servicePledgeTable" class="table table-striped table-bordered">
			<thead>
				<tr>
...
<spring:url value="/wro/servicePledgeTableJs.js" var="servicePledgeTableJs" />
  
<script src="${servicePledgeTableJs}"></script>
