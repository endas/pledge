...
var frmApplicationUserDetailsOrganisationNameBuffer = document.getElementById("frmApplicationUserDetailsOrganisationName").value;

var frmApplicationUserDetailsOrganisationNameTextBuffer = getSelectedText(document.getElementById("frmApplicationUserDetailsOrganisationName"));   
...
//	if (document.getElementById("frmApplicationUserDetailsOrganisationName").value != frmApplicationUserDetailsOrganisationNameBuffer){
//		document.getElementById("frmApplicationUserDetailsOrganisationNameFormGroup").className += " has-error";
//		replaceText(document.getElementById("frmApplicationUserDetailsOrganisationNameHelpBlock"), "Previous Value: " + frmApplicationUserDetailsOrganisationNameTextBuffer);
//
//		if (focusSet == false){
//			focusControl = document.getElementById("frmApplicationUserDetailsOrganisationName");
//			focusSet = true;
//		}
//		changedCounter++;
//	}
