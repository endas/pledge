	...
	$(document).ready(function(){
		...
		var referenceCategoryTable = $('#referenceCategoryTable').DataTable({
			ajax: {
				url: rootContext + "/restful/referencecategory/list",
				dataSrc: '',
				"deferRender": true
			},
			"columnDefs": [ {
				...
				"data": function ( row, type, val, meta ) {
					...
					var deleteURI = rootContext + "/referencecategory/" + row.id + "/update";
