...
$( document ).ready(function() {
	...
	try{
		var feedbackMessage = document.getElementById('frmReferenceLoadedFeedbackMessage').value
		var feedbackCss = document.getElementById('frmReferenceLoadedFeedbackCss').value
	...
	var mainFormObjectId = document.getElementById("frmReferenceReferenceId").value;
	...
	if (displayTextAreaCount){
		...
		$('#frmReferenceDescriptionCountBlock').text($('#frmReferenceDescription').val().length.toString().concat('/').concat('200'));
...
if ($('#frmReferenceMode').val() == 'LOCALIZE'){
	$('#existingLocale').change(function () {
		...
		$.ajax({
			...
			data: {
			id: $('#frmReferenceReferenceViewId').val()
			},
...
} // end if ($('#frmReferenceMode').val() == 'LOCALIZE')
	...
	function frmReferenceExitButtonClicked(){
		...
		if (document.getElementById("frmReferenceRefType").value != frmReferenceRefTypeBuffer){
			...
			replaceText(document.getElementById("frmReferenceRefTypeHelpBlock"), "Previous Value: " + frmReferenceRefTypeBuffer);
		...
		if (document.getElementById("frmReferenceRefDesc").value != frmReferenceRefDescBuffer){
			...
			replaceText(document.getElementById("frmReferenceRefDescHelpBlock"), "Previous Value: " + frmReferenceRefDescBuffer);
		...
		if (document.getElementById("frmReferenceParentId").value != frmReferenceParentIdBuffer){
			...
			replaceText(document.getElementById("frmReferenceParentIdHelpBlock"), "Previous Value: " + frmReferenceParentIdBuffer);
		...
		if (document.getElementById("frmReferenceRefIndex").value != frmReferenceRefIndexBuffer){
			...
			replaceText(document.getElementById("frmReferenceRefIndexHelpBlock"), "Previous Value: " + frmReferenceRefIndexBuffer);
		...
		if (document.getElementById("frmReferenceDescription").value != frmReferenceDescriptionBuffer){
			...
			replaceText(document.getElementById("frmReferenceDescriptionHelpBlock"), "Previous Value: " + frmReferenceDescriptionBuffer);
